...
<form action = "emp_submit.php" method="post">
...
<div id="signup-box-name">
Company:</div><div id="login-box-field"><input name="company" required type='text' id='com' class="form-login" title="company" size="30" maxlength="20" /></div>
<div id="submit">
